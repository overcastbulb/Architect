...
const CITIES = [
  ...
  { label: "Mumbai", keywords: ["mumbai", "bombay", "bandra", "andheri", "worli", "powai", "malad", "borivali", "thane", "navi mumbai", "dadar", "kurla", "goregaon", "juhu", "colaba", "bkc"], lat: 19.076, lng: 72.8777 },
